...
<div class="row row-deck row-cards">
                        ...
                        <div class="row g-2 align-items-center">
                            <div class="col">
                                ...
                                <div class="small mt-1">
                                    <span> Last Logged in : {{ Carbon\Carbon::parse( Auth()->user()->last_login_at )->diffForHumans() }} </span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <div class="text-muted">
                                    Rp. {{ number_format($checkBalance['data']->deposit) }}
                                </div>
                                @else
                                <div class="text-muted">
                                    Rp. {{ number_format($usersbalance->balance) }}
                                </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="col-sm-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    @foreach ($last_seen as $users)
                    <div class="col-sm-6">
                        <div class="row g-3 align-items-center">
                            <a class="col-auto">
                            </a>
                            <div class="col text-truncate">
                                <span class="text-body d-block text-truncate">{{ $users->username }} </span>
                                @if(Cache::has('user-is-online-' . $users->id))
                                <span class="badge bg-green"></span>
                                <small class="text-muted text-truncate mt-n1">Online</small>
                                @else
                                <span class="badge bg-red"></span>
                                <small class="text-muted text-truncate mt-n1">Last Online : {{ Carbon\Carbon::parse($users->last_seen)->diffForHumans() }}</small>
                                @endif
                            </div>
                        </div>
                    </div>
