            ...
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <!-- Order -->
                     ...
                     <li class="nav-item {{ (request()->is('admin/order*')) ? 'active' : '' }} dropdown">
                    ...
                    <!-- Games -->
                    <li class="nav-item {{ (request()->is('admin/games*')) ? 'active' : '' }} {{ (request()->is('admin/products*')) ? 'active' : '' }}">
                    ...
                    <!-- Deposit -->
                    <li class="nav-item {{ (request()->is('admin/deposit*')) ? 'active' : '' }} dropdown">
                        <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ route('history-deposit') }}">
                                History
                            </a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item {{ (request()->is('admin/auth*')) ? 'active' : '' }} dropdown">
                        <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('auth.roles') }}">
                                Roles
                            </a>
                            <a class="dropdown-item" href="{{ route('auth.users') }}">
                                Users
                            </a>
                        </div>
                    </li>
                    ...
                    @endif
                    <li class="nav-item {{ (request()->is('admin/winrate*')) ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('winrate') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
