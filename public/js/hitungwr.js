...
const hasil = document.querySelector("#buttonResult");
const resultText = document.querySelector("#resultText");

// Functions
function res() {
    const resultNum = rumus(tMatch.value, tWr.value, wrReq.value);
    const text = `You need about <b>${resultNum}</b> win without lose to achieve win rate <b>${wrReq.value}%</b>`;
...
function eventListener() {
    buttonResult.addEventListener("click", res);
}