...
<div class="col-auto ms-auto d-print-none">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="add-roles" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            <form action="<?php echo e(route('new-games')); ?>" method="POST" autocomplete="off">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="card">
            <div class="card-body p-4 text-center">
                ...
                <div class="text-muted mt-1"><small><?php echo e($games->products->count()); ?></small></div>
                <div class="text-muted mt-3">Server Status</div>
                <div class="mt-1">
                    <span class="badge <?php if($games->status == '1'): ?> bg-green-lt <?php elseif($games->status == '0'): ?> bg-red-lt <?php endif; ?>"> <?php if($games->status == '1'): ?> Online <?php elseif($games->status == '0'): ?> Offline <?php endif; ?></span>
                </div>
            </div>
            <div class="d-flex">
                <a href="/admin/products/<?php echo e($games->slug); ?>" class="card-btn">
                ...
                <a href="/admin/games/edit/<?php echo e($games->slug); ?>" class="card-btn">
                ...
                <a href="/admin/games/del/<?php echo e($games->slug); ?>" class="card-btn">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kibostor/public_html/resources/views/admin/games/index.blade.php ENDPATH**/ ?>