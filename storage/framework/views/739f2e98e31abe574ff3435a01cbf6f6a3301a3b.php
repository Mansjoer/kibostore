...
<head>
    ...
    <!-- Load the stylesheet. -->
    <link href="<?php echo e(asset('landing/css/identity.min.css')); ?>" rel="stylesheet">
...
<body>
            ...
            <div class="content py-5">
                <h1 class="display-3 font-weight-bold">
                    ...
                    <div id="typed-strings">
                        <?php $__currentLoopData = $datagame; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p><?php echo e($game->display_name); ?></p>
                ...
                <div class="hero-drawing py-5 mx-auto">
                    <img src="<?php echo e(asset('landing/img/drawing-hero.svg')); ?>" alt="Drawing hero" class="img-fluid">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-end py-3">
                    ...
                    <img src="<?php echo e(asset('landing/img/drawing-contact.svg')); ?>" alt="" class="img-fluid">
    ...
    <script src="<?php echo e(asset('landing/lib/jquery.min.js')); ?>"></script> <!-- jQuery -->
    <script src="<?php echo e(asset('landing/lib/popper.min.js')); ?>"></script> <!-- Popper.js - dependency of Bootstrap -->

    <script src="<?php echo e(asset('landing/js/plugins.min.js')); ?>"></script> <!-- Load plugins -->

    <script src="<?php echo e(asset('landing/js/main.min.js')); ?>"></script> <!-- Other javascript -->

</body>

</html>
<?php /**PATH /home/kibostor/public_html/resources/views/landing/index.blade.php ENDPATH**/ ?>